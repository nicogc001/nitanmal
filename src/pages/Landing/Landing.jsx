        ...
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-16 md:grid-cols-2 md:py-24">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <button className="flex items-center justify-center gap-2 rounded-full bg-green-700 px-7 py-4 font-bold text-white">
          ...
          <div className="rounded-[2.5rem] bg-white p-5 shadow-2xl">
            <div className="rounded-[2rem] bg-[#eef8eb] p-6">
              ...
              <p className="mt-4 text-slate-700">
                ...
                <strong className="text-green-800">230€/mes</strong>.
              </p>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          <div className="grid gap-5 md:grid-cols-4">
            <Feature
              icon={<BarChart3 />}
              title="Sueldo real"
              text="Calcula lo que realmente te queda."
            />
  
            <Feature
              icon={<Car />}
              title="Transporte"
              text="Gasolina, mantenimiento y tiempo."
            />
            ...
            <Feature
              icon={<ShieldCheck />}
              title="Tranquilidad"
              text="Una visión humana de tus finanzas."
            />
          </div>
        </section>
      </main>
